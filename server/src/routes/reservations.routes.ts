...
// when someone calls GET /api/reservations/me, execute getMyReservations
router.get('/me', checkToken, getMyReservations)
// When someone calls GET /api/reservations execute getAllReservations
router.get('/', checkToken, getAllReservations)
